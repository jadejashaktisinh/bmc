  ...
  return (
      <div className="px-8 py-24 flex flex-col gap-16">
        ...
        <div className="grid grid-cols-[1fr_1fr_1fr] gap-8">
           ...
           <PricingCard plan="Enterprice" price="Custome" list={['Active Tenants','White-label Dashboard','Custom SLA Agreements' ,'Dedicated Success Manager']} btnText="Get Started"/>
        </div>
      </div>
  );
}
